<template>
	<el-card class="box-card">
		...
		<el-form ref="form" :model="form" :rules="rules" label-width="80px">
			<el-form-item label="用户名" prop="username"><el-input v-model.trim="form.username"></el-input></el-form-item>
			<el-form-item label="姓名" prop="fullname"><el-input v-model.trim="form.fullname"></el-input></el-form-item>
			...
			<el-form-item label="手机" prop="tel"><el-input v-model.trim="form.tel"></el-input></el-form-item>
			<el-form-item label="邮箱" prop="email"><el-input v-model.trim="form.email"></el-input></el-form-item>
			<el-form-item label="头像" prop="avatar">
				<single-upload
					:src.sync="form.avatar"
					default-image="http://localhost:3001/images/avatar/default.jpg"
					upload-action="/upload/common/"
					remove-action="/upload/delete"
					:headers="headers"
					:data="{ type: 'avatar' }"
				></single-upload>
			</el-form-item>
			<el-form-item><el-button @click="submitForm('form')" size="medium" type="primary">保存修改</el-button></el-form-item>
		</el-form>
	</el-card>
</template>
