<template>
	<el-card class="box-card">
		...
		<el-form ref="form" :model="form" label-width="80px">
			<el-form-item label="用户名"><el-input v-model.trim="form.username" disabled></el-input></el-form-item>
			<el-form-item label="姓名"><el-input v-model.trim="form.fullname"></el-input></el-form-item>
			...
			<el-form-item label="手机"><el-input v-model.trim="form.tel"></el-input></el-form-item>
			<el-form-item label="邮箱"><el-input v-model.trim="form.email"></el-input></el-form-item>
			...
			<el-form-item><el-button @click="handleSave" size="medium" type="primary">修改资料</el-button></el-form-item>
		</el-form>
	</el-card>
</template>
